...
class RewardFunction():
    ...
    #     print("PV values in the reward: ", state[-1,self.agentIndex.index(self.PVindex)])
    #     print("SV values in the reward: ", state[-1,self.agentIndex.index(self.SVindex)])
    #     error = abs(state[-1,self.agentIndex.index(self.PVindex)] - \
    #             state[-1,self.agentIndex.index(self.SVindex)])
